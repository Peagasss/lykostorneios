        ...
        <div class="container">
          ...
          <div class="match-summary-card" style="margin-top: 1.75rem;">
            ...
            <div class="team-box away">
              <img src="${match.opponent_logo || settings.default_opponent_logo || 'assets/logo-adversario-padrao.webp'}" alt="${match.opponent_name || 'Adversário'}" class="team-logo-img" style="width: 64px; height: 64px;">
              <div>
